        ...
        <>
            <div id="footer-bottom" className='instructor-profile'>
                ...
                <div className="instru-bg-image">
                    <h1>Get Verification Badge</h1>
                    <p>Home / <span>Get Verification Badge</span></p>
                </div>
                                        ...
                                        <div className='getverificationbadge-section'>
                                            <div className='plan-section'>
                                                <div className='plan-box'>
                                                    <div className="radio-box">
                                                        <div className="check-box-create">
                                                            ...
                                                            <label htmlFor="plan1"><div><h3>Plan Name Here</h3><p>30 days</p></div> <div><h2>$2 <span>/ Month</span></h2></div></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className='plan-box'>
                                                    <div className="radio-box">
                                                        <div className="check-box-create">
                                                            <input required type="radio" id="plan2" name="month" value="" />
                                                            <label htmlFor="plan2"><div><h3>Plan Name Here</h3><p>365 Days</p></div> <div><h2>$20<span>/ Year</span></h2></div></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='paymentmethod-box'>
                                                ...
                                                <div className='payment-three-card'>
                                                        ...
                                                        <div className="radio-box">
                                                            <div className="check-box-create">
                                                                <label htmlFor="card1"><div>
                                                                    ...
                                                                    <div>
                                                                        <p>xxxx xxxx xxxx 3256</p>
                                                                    </div>
                                                                </label>
                                                                <input required type="radio" id="card1" name="card" value="" defaultChecked />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className='cardnumber-box'>
                                                        <div className="radio-box">
                                                            <div className="check-box-create">
                                                                <label htmlFor="card2"><div>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="72.917" height="46" viewBox="0 0 72.917 46">
                                                                        <g id="Group_4988" data-name="Group 4988" transform="translate(4282.166 -5614)">
                                                                            <path id="Path_671" data-name="Path 671" d="M75.751,42.6c0-3.5-1.82-5.24-5.351-5.24H8.184A4.947,4.947,0,0,0,4.268,38.8,5.1,5.1,0,0,0,2.834,42.6V78.125a5.137,5.137,0,0,0,1.434,3.805,5.313,5.313,0,0,0,3.916,1.434H70.4c3.531,0,5.351-1.764,5.351-5.239ZM4.9,81.3C4.075,80.5,5.7,82.124,4.9,81.3Z" transform="translate(-4285 5576.635)" fill="#fff" fillRule="evenodd" />
                                                                            <path id="Path_667" data-name="Path 667" d="M75.751,42.6c0-3.5-1.82-5.24-5.351-5.24H8.184A4.947,4.947,0,0,0,4.268,38.8,5.1,5.1,0,0,0,2.834,42.6V78.125a5.137,5.137,0,0,0,1.434,3.805,5.313,5.313,0,0,0,3.916,1.434H70.4c3.531,0,5.351-1.764,5.351-5.239ZM70.4,38.192c2.923,0,4.413,1.489,4.413,4.412V78.125c0,2.95-1.49,4.412-4.413,4.412H8.184a4.257,4.257,0,0,1-4.523-4.412V42.6c0-2.923,1.462-4.412,4.523-4.412Z" transform="translate(-4285 5576.635)" fill="#315881" fillRule="evenodd" />
                                                                            <path id="Path_668" data-name="Path 668" d="M13.345,44.724A3.278,3.278,0,0,0,11,45.331a3.965,3.965,0,0,0-.524,2.372V55.4H77.436V47.7c0-2.013-.993-2.978-2.979-2.978Z" transform="translate(-4289.664 5572.287)" fill="#315881" fillRule="evenodd" />
                                                                            <path id="Path_669" data-name="Path 669" d="M10.477,128.059c0,2.04.965,3.088,2.868,3.088H74.457c1.985,0,2.979-1.048,2.979-3.088v-7.694H10.477Z" transform="translate(-4289.664 5526.126)" fill="#dfa43b" fillRule="evenodd" />
                                                                            <path id="Path_670" data-name="Path 670" d="M46.942,77.807a1.418,1.418,0,0,1-.193.827l-4.826,8.411-.3-10.259H33.9l2.592,1.241a2.117,2.117,0,0,1,1.131,1.848l.717,10.894h3.778l9.046-13.982H46.529A1.373,1.373,0,0,1,46.942,77.807ZM78.161,77.2l.3-.414H73.748c.165.165.221.248.221.3a5.3,5.3,0,0,1-.221.524l-6.867,12.52c-.165.221-.331.414-.524.635h3.888l-.193-.414a5.929,5.929,0,0,1,.607-1.958l.827-1.545h4c.166,1.3.276,2.372.331,3.172l-.331.744h4.826l-.717-1.048L78.161,77.2Zm-2.869,7.694H72.424l2.454-4.716ZM63.379,76.07a6.359,6.359,0,0,0-3.888,1.241,3.133,3.133,0,0,0-1.848,2.758,4.427,4.427,0,0,0,1.324,3.282L61.642,85.2c.965.69,1.434,1.3,1.434,1.848a1.679,1.679,0,0,1-.717,1.351,2.584,2.584,0,0,1-1.655.524c-.965,0-2.62-.689-4.909-1.958v2.565a10.154,10.154,0,0,0,5.212,1.628,6.036,6.036,0,0,0,4.11-1.434,3.618,3.618,0,0,0,.413-6.04l-2.565-1.848c-.854-.689-1.323-1.3-1.323-1.765,0-1.075.634-1.627,1.93-1.627a8.672,8.672,0,0,1,3.916,1.545l.525-2.675a9.189,9.189,0,0,0-4.634-1.241ZM53.12,90.769c-.055-.579-.166-1.1-.221-1.655l3.5-11.307.827-1.02H52.182c.055.248.11.579.166.827a4.3,4.3,0,0,1-.055.827l-3.5,11.2-.717,1.131H53.12Z" transform="translate(-4303.957 5553.157)" fill="#315881" fillRule="evenodd" />
                                                                        </g>
                                                                    </svg>
                                                                </div>
                                                                    <div>
                                                                ...
                                                                <input required type="radio" id="card2" name="card" value="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className='cardnumber-box'>
                                                        <Link className="btn" onClick={handleShow}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                                                                <rect id="Rectangle_1951" data-name="Rectangle 1951" width="40" height="40" rx="5" fill="#fed756" />
                                                                <g id="Group_4989" data-name="Group 4989" transform="translate(8 8)">
                                                                    <path id="Path_672" data-name="Path 672" d="M0,0H24V24H0Z" fill="none" />
                                                                    <line id="Line_204" data-name="Line 204" y2="14" transform="translate(12 5)" fill="none" stroke="#2d2d2d" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                                                                    <line id="Line_205" data-name="Line 205" x2="14" transform="translate(5 12)" fill="none" stroke="#2d2d2d" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                                                                </g>
                                                            </svg>
                                                        </Link>
                                                    </div>
                                    ...
                                    <div className='change-password-box billinghistory'>
                                        <Accordion>
                                            <Accordion.Item eventKey="0">
                                                <Accordion.Header>Billing History</Accordion.Header>
                                                <Accordion.Body>
                                                    <div className='manages-section'>
                                                        <Table striped responsive>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>01 Sept'22</td>
                                                                    <td>Plan Name Here, monthly</td>
                                                                    <td><span>$2.00</span></td>
                                                                    <td><p>Invoice 01 Sep 22</p></td>
                                                                </tr>
            ...
            <Modal className='center-modal class-modal problemsolving rejectbooking paymentmethod' show={show} onHide={handleClose}>
                ...
                <Modal.Body className='blogdetails-modal'>
                    <div className='classtype-section'>
                        <div className='payment-type'>
                            <div className='stripe'>
                                <div className="form-check">
                                    ...
                                    <input required className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" defaultChecked />
                                </div>
                            </div>
                            ...
                            <label className="form-check-label" htmlFor="flexRadioDefault2">
                                <img src="/images/stripe2.png" alt="" />    
                                Stripe
                                </label>
                            ...
                            <div className='stripe'>
                                <div className="form-check">
                                    ...
                                    <input required className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault3" />
                                </div>
                            </div>
                        ...
                        <div className='year-date-cvv dropdown-select card-section2'>
                            ...
                            <div className='date-cvv'>
                                <label className="custom-field one">
                                    <input required type="text" />
                                    <span className="placeholder">CVV</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className='checkbox-box'>
                            <div className="check-box-create">
                                ...
                                <label htmlFor="vehicle1">Save card for future use</label>
                            </div>
                        </div>
