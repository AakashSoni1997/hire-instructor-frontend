...
import OndemandClassStepOne from "./OndemandClassStepOne";
import OndemandClassStepTwo from "./OndemandClassStepTwo";
import OndemandClassStepThree from "./OndemandClassStepThree";
...
const Ondemandclass = () => {
    ...
    const amount = instructorDetailsState?.user_extra_info?.[0]?.on_demand_price;
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="step-content-block">
                                {activeStep === 'subject-and-level' && <OndemandClassStepOne setActiveStep={setActiveStep} amount={amount} />}
                                {activeStep === 'payment-method' && <OndemandClassStepTwo setActiveStep={setActiveStep} amount={amount} />}
                                {activeStep === 'checkout' && <OndemandClassStepThree setActiveStep={setActiveStep} amount={amount} />}
                            </div>
                        </div>
                    </div>
                </div>
